...
export default function Footer({
  ...
  const footerLinks = {
    [dict.footer.product]: [
      ...
      { name: dict.footer.docs, href: "/docs" },
    ...
    [dict.footer.resources]: [
      ...
      { name: dict.footer.github, href: "https://github.com/lunar-org-ai/lunar-router" },
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-8 pt-8 border-t border-[var(--color-border)] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link href="https://github.com/lunar-org-ai/lunar-router" className="text-[var(--color-muted)] hover:text-[var(--color-foreground)] transition-colors" aria-label="GitHub">
            ...
            <Link href="https://discord.gg/gDNPhQ347V" className="text-[var(--color-muted)] hover:text-[var(--color-foreground)] transition-colors" aria-label="Discord">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="https://x.com" className="text-[var(--color-muted)] hover:text-[var(--color-foreground)] transition-colors" aria-label="X">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
