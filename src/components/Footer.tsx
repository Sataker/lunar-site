  ...
  return (
    <footer className="border-t border-[#e5e5e5] bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-8 pt-8 border-t border-[#e5e5e5] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#666666]">
            &copy; {new Date().getFullYear()} {dict.footer.copyright}
          </p>
          <div className="flex items-center gap-4">
            <Link href="https://github.com/lunar-org-ai/lunar-router" className="text-[#666666] hover:text-[#111] transition-colors" aria-label="GitHub">
            ...
            <Link href="https://discord.gg/gDNPhQ347V" className="text-[#666666] hover:text-[#111] transition-colors" aria-label="Discord">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="https://x.com" className="text-[#666666] hover:text-[#111] transition-colors" aria-label="X">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
