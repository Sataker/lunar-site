  ...
  return (
    <footer className="border-t border-[#333333] bg-black">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-[#888888] max-w-xs">
              Cut LLM costs by 57% with automated distillation pipelines.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-[#333333] flex flex-col sm:flex-row items-center justify-between gap-4">
