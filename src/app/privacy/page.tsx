        ...
        <div className="mt-16 max-w-3xl mx-auto space-y-16">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">01.</span> Information We Collect
            </h2>
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">02.</span> How We Use Your
              Information
            </h2>
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">03.</span> How We Share Your
              Information
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6 space-y-6">
              <p className="text-sm text-[#cccccc] leading-relaxed">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">04.</span> Data Retention
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6">
              <p className="text-sm text-[#cccccc] leading-relaxed">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">05.</span> Data Security
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6">
              <p className="text-sm text-[#cccccc] leading-relaxed">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">06.</span> Your Rights
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">07.</span> International Data
              Transfers
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6">
              <p className="text-sm text-[#cccccc] leading-relaxed">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">08.</span> Children&apos;s
              Privacy
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6">
              <p className="text-sm text-[#cccccc] leading-relaxed">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">09.</span> Changes to This Policy
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6">
              <p className="text-sm text-[#cccccc] leading-relaxed">
          ...
          <section>
            <h2 className="font-mono text-lg font-bold uppercase tracking-tight mb-4 flex items-center gap-2">
              <span className="text-[#f59e0b]">10.</span> Contact Us
            </h2>
            <div className="border border-[#333333] bg-[#0a0a0a] p-6">
              <p className="text-sm text-[#cccccc] leading-relaxed">
