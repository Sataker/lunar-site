...
export default async function PlatformPage({
  ...
  return (
    <div className="pt-24 pb-16 min-h-screen">
      {/* Hero */}
      <section className="py-16 section-glow-blue">
        <Container>
          <FadeIn>
      ...
      {sectionKeys.map((key, index) => {
        ...
        const glowClass = isEven ? "section-glow-orange" : "section-glow-blue";
        const showCode =
          key === "gateway"
            ? gatewayCode
            : key === "routing"
        ...
        return (
          <section key={key} className={`py-20 ${glowClass}`}>
            <Container>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                {/* Right: code or visual card */}
                <SlideIn direction={isEven ? "right" : "left"} delay={0.15}>
                  {showCode ? (
                    <CodeBlock
                      code={showCode}
                      language="python"
